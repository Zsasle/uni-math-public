...
\end{subnote}
\begin{subproof*}[Bemerkung \ref{3.24.1}]
	ÜA
\end{subproof*}

\begin{subtheorem}[Jordan Normalform]
...
\end{subtheorem}
\begin{subproof*}[Satz \ref{3.24.2} Jordan Normalform]
...
\end{subcorollary}
\begin{subproof*}[Korollar \ref{3.24.4}]
