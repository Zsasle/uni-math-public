...
\begin{theorem}[Lagrange-Multiplikatoren]
	...
	\fbox{$ Dh(a) = \lambda D f(a). $} Ein solches $ \lambda $ heißt \textbf{Lagrangemultiplikator}.
	\begin{itemize}
		\item Sagt nur, was in kritischen Punkten gelten muss!
	\end{itemize}
\end{theorem}
\begin{proof*}[Theorem \ref{6.14} Lagrange-Multiplikatoren]
	\OE{} $ \partial_n f(a) \neq 0 $, $ n \geq 2 $.
	\[
...
\textbf{Letztes Mal:} Lagrange-Multiplikatoren
\begin{itemize}
